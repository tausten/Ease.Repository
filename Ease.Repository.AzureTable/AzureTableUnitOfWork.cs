...
namespace Ease.Repository.AzureTable
{
        ...
        where TContext : class, IAzureTableRepositoryContext
    {
        private class EntityBookKeeping
        {
            ...
            /// </summary>
            public ITableEntity CopyOfOriginalForUndo;
        ...
        private readonly MapOfHashSets<Type, ITableEntity> _addedEntities
            = new MapOfHashSets<Type, ITableEntity>();

        private readonly MapOfHashSets<Type, ITableEntity> _deletedEntities
            = new MapOfHashSets<Type, ITableEntity>();
        ...
        private readonly Dictionary<ITableEntity, EntityBookKeeping> _bookKeeping
            = new Dictionary<ITableEntity, EntityBookKeeping>();
        ...
        public IAzureTableRepositoryContext Context { get; private set; }

        public TEntity RegisterAdd<TEntity>(
        ...
        public IEnumerable<TEntity> RegisterForUpdates<TEntity>(IEnumerable<TEntity> entities, Action<TEntity> updateAction)
            where TEntity : class, ITableEntity, new()
        {
            var trackedEntities = new List<TEntity>();
            foreach (var entity in entities)
            {
                var trackedEntity = TrackEntityForUpdates(entity, updateAction, updateAction);
                trackedEntities.Add(trackedEntity);
            }
            return trackedEntities;
        }

        public void RegisterDelete<TEntity>(
        ...
        private EntityBookKeeping GetBookKeepingFor(ITableEntity entity)
        {
        ...
        private TEntity TrackEntityForUpdates<TEntity>(TEntity entity, Action<TEntity> updateAction, Action<TEntity> undoAction) where TEntity : class, ITableEntity, new()
        {
